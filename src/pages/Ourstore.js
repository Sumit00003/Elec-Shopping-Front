                                ...
                                <div className='product-tags d-flex flex-wrap align-items-center gap-10'>
                                    {
                                        tags && [...new Set(tags)]?.map((item, index) => {
                                            return (
                                                <span onClick={() => setTag(item)} key={index} className='text-capitalize badge bg-light text-secondary rounded-3 py-2 px-3'>{item}</span>
                                ...
                                <div className='product-tags d-flex flex-wrap align-items-center gap-10'>
                                    {
                                        brands && [...new Set(brands)]?.map((item, index) => {
                                            return (
                                                <span onClick={() => setBrand(item)} key={index} className='text-capitalize badge bg-light text-secondary rounded-3 py-2 px-3'>{item}</span>
                        ...
                        <div className='filter-sort-grid mb-4'>
                            <div className='d-flex justify-content-between align-items-center'>
                                <div className='d-flex align-items-center gap-10'>
                                    ...
                                    <select name=" " defaultValue={"DEFAULT"} className='form-control form-select' id='' onChange={(e)=>setSort(e.target.value)}>
